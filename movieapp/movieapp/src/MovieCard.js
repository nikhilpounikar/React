            ...
            <div className="right">
              ...
              <div className="footer">
                ...
                <div className="star-dis">
                    ...
                    <img onClick={this.decreaseCount} alt="decrease" src="https://cdn-icons-png.flaticon.com/128/2801/2801932.png" className="str-btn" />
                    ...
                    <img alt="increase" onClick={this.increaseCount} src="https://cdn-icons-png.flaticon.com/128/1828/1828925.png" className="str-btn" />
                    //count goes here
                    <span className="starCount">{stars}</span>
                </div>
                <button className={fav?'un-favorite-btn':'favorite-btn'} onClick={this.handleFavorite}>{fav?'UnLike':'Like'}</button>
                <button className={cartState?'cart-btn':'un-cart-btn'} onClick={this.handleAddCart}>{cartState?'Remove From Cart':'Add To Cart'}</button>
